...
4. 再读 docs/obsidian/notes/2026-04-27-agent-current-state-and-doc-coverage.md → 确认最新状态、遗留边界、Obsidian 覆盖
5. 再读 docs/CORE_MODULES_OVERVIEW.md → 找到要施工的模块边界
6. 再读 docs/AI_REPLY_GENERATION_SYSTEM.md → 理解 AI 回复、Experience Router 和 SFT 写入入口
7. 最后读 docs/OBSIDIAN_MEMORY_STANDARD.md → 了解当前记忆与文档同步规则
```
...
| `docs/obsidian/notes/2026-04-27-profile-skill-memory-direction.md` | 用户画像 Markdown / skill memory 方向记录 |
...
- Status: synced
- Note: `docs/obsidian/notes/2026-04-25-agent-onboarding-and-bot-integration.md`, `docs/obsidian/notes/2026-04-27-agent-current-state-and-doc-coverage.md`
