...
CREATE UNIQUE INDEX uk_message_archive_monthly ON message_archive_monthly_rollups(table_name, archive_month, creator_id, group_chat_id, operator);
CREATE INDEX idx_message_archive_month ON message_archive_monthly_rollups(archive_month);
CREATE INDEX idx_message_archive_creator ON message_archive_monthly_rollups(creator_id);
CREATE INDEX idx_message_archive_group ON message_archive_monthly_rollups(group_chat_id);
...
-- ============================================================
-- WA Worker Contact Confirmations
-- ============================================================
