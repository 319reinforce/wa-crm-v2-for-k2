...
- [[notes/2026-04-27-agent-current-state-and-doc-coverage|Agent Current State And Doc Coverage]]
...
- [[notes/2026-04-28-wangyouke-phone-normalization-translation-handoff|WangYouKe Phone Normalization And Translation Handoff]]
...
1. Put the note under `docs/obsidian/notes/`.
2. Link it from the relevant section above.
3. Add an `Obsidian Sync` block to the source document when applicable.
