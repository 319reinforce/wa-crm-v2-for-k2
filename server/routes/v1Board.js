  ...
  try {
    ...
    const creators = creatorRows.map(row => {
      ...
      return {
        ...
        monthly_fee_amount: row.monthly_fee_amount || 0,
        keeper_username: row.keeper_username || null,
        keeper_gmv: row.keeper_gmv || null,
        keeper_gmv30: row.keeper_gmv30 || null,
        keeper_orders: row.keeper_orders || null,
        keeper_videos: row.keeper_videos || null,
        keeper_videos_posted: row.keeper_videos_posted || null,
        keeper_videos_sold: row.keeper_videos_sold || null,
