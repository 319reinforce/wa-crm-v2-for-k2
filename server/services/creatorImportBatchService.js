...
async function ensureCreatorImportBatchSchema() {
    ...
    await assertManagedSchemaReady(dbConn, {
        feature: 'Creator import',
        migration: 'server/migrations/007_creator_import_tables.sql',
        tables: ['operator_outreach_templates', 'creator_import_batches', 'creator_import_items'],
        columns: {
            operator_outreach_templates: ['id', 'owner', 'template_key', 'label', 'body', 'is_active', 'created_by', 'created_at', 'updated_at'],
            creator_import_batches: ['id', 'owner', 'source', 'status', 'send_welcome', 'welcome_template_id', 'welcome_template_key', 'welcome_text', 'total_count', 'created_count', 'reused_count', 'skipped_count', 'error_count', 'welcome_queued_count', 'welcome_sent_count', 'welcome_failed_count', 'created_by', 'started_at', 'completed_at', 'created_at', 'updated_at'],
            creator_import_items: ['id', 'batch_id', 'row_index', 'creator_id', 'owner', 'input_name', 'input_phone', 'normalized_name', 'normalized_phone', 'import_status', 'send_status', 'error', 'wa_message_id', 'routed_session_id', 'routed_operator', 'attempt_count', 'last_attempt_at', 'sent_at', 'created_at', 'updated_at'],
        },
    });
    schemaReady = true;
}
